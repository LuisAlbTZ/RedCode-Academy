...
class Config:
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY', 'redcode-dev-secret-key-change-in-prod')

    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'postgresql+psycopg2://postgres:postgres@db:5432/redcode_academy') 
